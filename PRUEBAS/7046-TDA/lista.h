...
public:                              // metodos
    ...
    void insertarNodoInicio(Tipo1 x); // inserta un nuevo valor como primer nodo de la lista
    void insertarNodoFinal(Tipo1 x);  // inserta un nuevo valor como ultimo nodo de la lista
    void insertarUnNodo(Tipo1 v, Nodo* ant);	//metodo que inserta un elemento nuevo en la lista luego del nodo ant
    void insertarEnOrden(Tipo1 v);			//metodo que inserta ordenadamente un valor dentro de una lista
    Nodo *buscarElemento(Tipo1 x);    // metodo que indica si un valor existe en la lista
    void eliminarNodo(Tipo1 x);       // metodo que elimina un nodo de la lista
...
void Lista::insertarUnNodo(Tipo1 v, Nodo* ant){	//metodo que inserta un elemento nuevo en la lista luego del nodo ant
...
void Lista::insertarEnOrden(Tipo1 v){			//metodo que inserta ordenadamente un valor dentro de una lista
	Nodo* nuevo;								//declaracion de un nuevo nodo
...
Nodo *Lista::buscarElemento(Tipo1 x) // metodo que indica si un valor existe en la lista
{
    Nodo *actual;                                    // referencia a nodo actual de la lista
    actual = getPrimero();                           // almacena temporalmente la posicion del primer nodo
...
void Lista::eliminarNodo(Tipo1 x)       // metodo que elimina un nodo de la lista
{
