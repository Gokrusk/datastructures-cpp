...
class CaminoMinimo {
	...
	public:
		...
		void Dijkstra(GrafoMatriz g, int origen); 	// calcular lo caminos m�nimos del v�rtice origen al resto de los v�rtices
...
int CaminoMinimo::minimo(bool F[]){					//metodo privado para encontrar el �ndice del v�rtice del grafo cuya distancia al origen sea m�nima (elegido entre los no marcados).
...
void CaminoMinimo::recuperaCamino(int v) { 			//metodo para regresar a sucesivos (anteriores) v�rtices que conforman el camino m�nimo
