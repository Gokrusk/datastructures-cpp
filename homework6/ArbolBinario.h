...
//==================================================================================================
	...
	NodoBinario* insertar(NodoBinario* rSub, Tipo v) {		//implementa la inserci�n de un nodo en AB
		...
		if (rSub == NULL) {									//arbol no tiene nodos
			...
			if (v < rSub->getDato()){						//valor buscado es menor que valor de nodo actual
				...
				if (v > rSub->getDato()){					//valor buscado es mayor que valor del nodo actual
					...
					NodoBinario* q = rSub; 					// nodo a quitar del �rbol
...
//==================================================================================================
	...
	NodoBinario* reemplazar(NodoBinario* act) {				//sustituye un nodo por otro en AB (parte de eliminaci�n)
		NodoBinario *a, *p;
		p = act;
...
//==================================================================================================
	...
	NodoBinario* buscar(NodoBinario* rSub, Tipo v) {		//implementa b�squeda de un nodo en el AB
